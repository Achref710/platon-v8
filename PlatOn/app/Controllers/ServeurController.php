...
class ServeurController extends Controller {
    public function dashboard() {
        ...
        // FIX: Check 'user_role' instead of 'role'
        if (!isset($_SESSION['user_role']) || $_SESSION['user_role'] !== 'serveur') {
            $this->redirect('auth/login?error=Accès+serveur+requis');
            return;
        }
        ...
        $this->view('serveur/dashboard', [
            ...
            'stats' => $stats,
            'user_email' => $_SESSION['user_email'] ?? 'Serveur'  // Add user info
        ]);
    }
    ...
    // ... autres méthodes - remember to add session_start() and check ...
}
?>